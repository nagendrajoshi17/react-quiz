...
export default function QuizScreenThree() {
  ...
  const quizDataQuestion = quizdata.filter(question => question.category === 'Entertainment');
  const quizDataAnswer = quizdata.filter(options => options.category === 'Entertainment');
